...
let locationSelect = document.querySelector("#locations-ddl");
let parkTypesSelect = document.querySelector("#park-type-ddl");
const parkTableBody = document.querySelector("#park-table-body");

const radioButtonLocation = document.querySelector("#park-location-radio");
...
function buildParkRow(tbody, thePark) {
  ...
  if (thePark.Visit) {
    ...
    anchorLink.href = thePark.Visit;
    cell7.appendChild(anchorLink);
  }
}

function loadParkTableForLocation() {
  clearParksTable();

  let location = locationSelect.value;
  let parksInLocations = nationalParksArray.filter(function (park) {
    return park.State == location;
  });
